...
def upload(pptx_path: str) -> str:
    """
    Uploads a PowerPoint file to the server.

    Args:
        pptx_path (str): Path to the PowerPoint file.

    Returns:
        str: File UUID generated by the server.
...
def status(file_uuid: str) -> Status:
    """
    Gets the status of a PowerPoint file from the server.

    Args:
        file_uuid (str): File UUID generated by the server.

    Returns:
        Status: Status object representing the file status.
